...
int cv_yolov8n_ob_init(bool security_enable, bool privilege_enable, uint32_t model_addr) {
	...
	if(model_addr != 0) {
		...
		//static const tflite::Model*yolov8n_ob_model = tflite::GetModel((const void *)epoch_200_int8_vela_tflite);
...
//BWS #if CHANGE_YOLOV8_OB_OUPUT_SHAPE
#if 0
